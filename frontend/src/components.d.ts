...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    copy: typeof import('./components/signup/SignUpFormFields copy.vue')['default']
    ...
    SignUpFormFieldsWithShareCode: typeof import('./components/signup/SignUpFormFieldsWithShareCode.vue')['default']
